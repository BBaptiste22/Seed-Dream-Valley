...
public class MenuScreen extends ScreenAdapter {
    ...
    private static final float BTN_Y = H - 160f;
    ...
    public void render(float delta) {
        ...
        drawTitle();
        drawStartButton();
        drawDivider(KEY_START_Y + 30f, "Touches de déplacement");
        drawKeysSection();
    }
    ...
    private void drawDivider(float y, String label) {
        ...
        shape.begin(ShapeRenderer.ShapeType.Filled);
        shape.setColor(COL_GOLD_DARK);
        shape.rect(KEY_LBL_X, y - layout.height - 2, layout.width + 20, 2);
        shape.end();
    }
    ...
    private void drawKeysSection() {
        ...
        String[] keyNames = {
            "Z","S","Q","D",
            "Clic gauche"  // ← affiché directement
        };

        for (int i = 0; i < 5; i++) {  // ← 5 au lieu de 4
